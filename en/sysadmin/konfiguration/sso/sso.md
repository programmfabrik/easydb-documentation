...
This configuration comes in the central file `easydb5-master.yml`, whose location you set in [install](../installation/installation.md).

For the complete list of options, see [YAML files](../config/yaml/yaml.md).
