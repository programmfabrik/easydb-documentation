...
`easydb5-master. yml` in the folder you defined during [installation](/sysadmin/installation/installation.html#mount).
...
| &#8614; `enable_post_settings`                     | Boolean       | No       | Allow requests on `POST /api/v1/schema/...` (e.g. `restart` or `purge*`) | False |
