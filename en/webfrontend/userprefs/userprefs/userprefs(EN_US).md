...
| E-mail schedule | For information on how to configure the e-mail schedule, see the section "Management" under [User](../../rightsmanagement/users/# schedule)|
...
| Setting | Note |
|--|--|
| Current password | Your current password. If you have forgotten your current password, you can start the [Password-forgetting-process](../../userprefs/loginscreen/) on the login page(if allowed by the administrator)
