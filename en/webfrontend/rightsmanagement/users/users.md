...
The preferences are saved for the [Group](../groups/groups.html#general) and can be taken over from an existing user or a pseudo-user, which was created especially for this purpose.
