...
![CSV-Importer](csv_importer_en.png)
...
- Files (See [Import files](../importfiles))
...
There is the possibility to import files via URL with the CSV Importer. The configuration options can be found in chapter [Import files](../importfiles).
...
| File upload type | This option is available if the objecttype contains one or more fields of type 'file'. See [Import files](../importfiles) |
