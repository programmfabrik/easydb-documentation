...
| &#8680;`egid`                                    | Integer        | No       | Effective group ID for running processes. If not configured, no group switch is attempted. (since version 5.81) | |
...
| &#8680;&#8680;`enable_asset_cleanup`             | Boolean        | No       | If enabled, assets not linked anymore are removed from database, the EAS may delete them (since version 5.90) | `true` (since 5.109.0, `false` before) |
| &#8680;`mailer` | | | |
