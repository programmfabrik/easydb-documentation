...
| &#8193;`datamodel:`            | Hierarchy   |                             | Contains the definition for the datamodel server                      |
| &#8193;&#8193;`uid:`           | String      |                             | Contains a uuid generated by programmfabrik to grant access to the Datamodel server |
| &#8193;&#8193;`server:`        | String      |                             | Address of the datamodel server (mostly: `https://schema.easydb.de/objectstore`) |
| &#8193;&#8193;`instance:`      | String      |                             | Instance name for the specified uuid, to identify the instance at the datamodel server |
|                                                    |                |          |             |         |
| `default_pics` | | | |
