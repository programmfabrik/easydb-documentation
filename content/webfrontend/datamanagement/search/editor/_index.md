...
|<code class="button">Kopieren</code>|Erzeugt eine Kopie des aktuellen Datensatzes. Bevor der Datensatz in der Datenbank angelegt wird, muss die Kopie durch Speichern bestätigt werden. Es werden nur die Inhalte der Felder kopiert, die in der aktuell ausgewählten Maske schreibbar sind (Inhalte die nicht oder nur lesend angezeigt werden, werden nicht kopiert).|- Sidebar-Editor (Toolbar) <br>- Vollbildeditor (Button)<br> - Kontextmenü in der Recherche<br/> - Detailansicht|
