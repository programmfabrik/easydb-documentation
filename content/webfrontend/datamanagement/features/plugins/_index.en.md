...
1. [Install Wordpress Plugin](../../../../sysadmin/plugin)
...
After the successful [plugin installation](../../../../sysadmin/konfiguration/plugin) and configuration in the [basic configuration](/en/webfrontend/administration/base-config/cms), files can be sent from easydb to Drupal.
