...
| Target field for timestamp | yes | | <ul><li>Must be a datetime field to store a complete timestamp</li><li>After a object was successfully updated, the timestamp is saved in this field</li><li>Only objects are searched where this field is unset, or where the timestamp is older than the specified max age (see below)</li></ul> |
