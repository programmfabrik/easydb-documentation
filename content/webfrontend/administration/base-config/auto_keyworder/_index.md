...
| Zielfeld für Zeitpunkt der Verschlagwortung | ja | | <ul><li>Es muss ein Datum&Zeit-Feld sein, um den Zeitpunkt zu speichern</li><li>Nachdem ein Datensatz erfolgreich aktualisiert wurde, wird der Zeitpunkt in diesem Feld gespeichert</li><li>Es werden nur Objekte gesucht, wo dieses Feld keinen Wert hat oder wo der Zeitpunkt älter als das bestimmte maximale Alter ist (siehe unten)</li></ul> |
...
| Mindestdauer seit der letzten automatischen Verschlagwortung | ja | `7` | <ul><li>Zeit, seitdem der Datensatz das letzte Mal aktualisiert wurde (in Tagen)</li><li>Es werden nur Datensätze gesucht, wo das Feld des Zeitpunktes keinen Wert hat oder wo der Zeitpunkt älter als diese Zeit ist</li><li>Wenn Daten in Datensätzen überschreiben werden sollen, die erst kürzlich geändert wurden, muss man den Zeitpunkt löschen</li></ul> |
