...
| **Wiederholungen Statusabfragen** | <ul><li> _verpflichtend_ </li><li>Maximale Anzahl der wiederholten Versuche, den Status der Verarbeitung eines Bildes beim externen Dienst abzufragen, bevor die Verschlagwortung des Bildes verworfen wird</li><li>Zusammen mit der Option **Pause zwischen Statusabfragen** kann die Gesamtzeit, die maximal auf die Verarbeitung eines Bildes beim externen Dienst gewartet wird, kontrolliert werden</li></ul> |
| **Pause zwischen Statusabfragen** | <ul><li> _verpflichtend_ </li><li>Mindestwartezeit in Sekunden zwischen wiederholten Statusabfragen eines Bildes</li><li>Nachdem der Status eines Bildes abgefragt wurde, und die Verschlagwortung nicht erfolgreich bzw abgebrochen war, wird mindestens so lange gewartet, bevor der Status erneut abgefragt wird</li><li>Zusammen mit der Option **Wiederholungen Statusabfragen** kann die Gesamtzeit, die maximal auf die Verarbeitung eines Bildes beim externen Dienst gewartet wird, kontrolliert werden</li><li>Je nach der Dauer einer einzelnen Statusabfrage (abhängig vom externen Dienst) kann grob die Gesamtzeit, nach der das Plugin nicht weiter auf die Verarbeitung eines Assets wartet, abgeschätzt werden, indem **Wiederholungen Statusabfragen** und **Pause zwischen Statusabfragen** multipliziert werden</li></ul> |
