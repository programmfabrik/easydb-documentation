...
Der Download erfolgt als ZIP-Datei. easydb unterstützt den Download verschiedener Dateigrößen (Varianten). [Eigene Varianten](/sysadmin/konfiguration/produce/produce/produce.html) können von einem Systemadministrator über eine .yml-Datei konfiguriert werden.
