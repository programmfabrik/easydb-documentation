...
|Passwort-Überprüfung| Hinweis|Der mehrsprachige Text erklärt dem Benutzer, was er bei seinem Passwort beachten muss.|
...
|Hinweise für Benutzer|Einleitungstext für eigene Einstellungen (Markdown)|Nachdem Login erscheint oben rechts das Benutzerprofil. Über das Menü können Benutzer Ihre Einstellungen ändern. Oben in diesen Einstellungen kann der Administrator einen Text für den Benutzer anzeigen lassen. |
|Selbstregistrierung für Benutzer erlauben||Neben dem Button für den Login, erscheint ein Button für die Registrierung, über den Benutzer selbst einen Account in easydb anlegen können. Eine Anleitung zur Einrichtung der Selbstregistrierung ist im Kapitel [Benutzerverwaltung](../userprefs/selfregister/selfregister.html) zu finden. |
