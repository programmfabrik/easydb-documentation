...
|Sperrung nach mehrfachen Fehlversuchen |Anzahl der Fehlversuche||
||Dauer der Sperre (in Sekunden)||
|Hinweise für Benutzer|Einleitungstext für eigene Einstellungen (Markdown)||
|Selbstregistrierung für Benutzer erlauben|||
||Einleitungstext für Selbstregistrierung (Markdown)||
||Bestätigungstext für Selbstsegistrierung (Markdown)||
