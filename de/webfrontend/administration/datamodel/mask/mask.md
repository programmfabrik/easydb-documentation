...
|Block| Felder können innerhalb eines Blocks als Einheit gruppiert und nebeneinander angeordnet werden. Blöcke können im Gegensatz zu den anderen Trenner nicht innerhalb eines Reitersystems angelegt werden. Mehrere Blöcke werden in der Sidebar untereinander angezeigt. Wird die Sidebar in die Breite gezogen oder das Vollbild gewählt, gleiten die Blöcke nebeneinander.  | 
